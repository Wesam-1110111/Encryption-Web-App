...
// btns
const decodingBtn = document.getElementById("coding-btn");
...
decodingBtn.addEventListener("click", function(){
    ...
    outputBox.textContent = decoding(kay)
});
...
function getIndex(text,kay){
    ...
    if(kay === "code0"){
        for(let i=0;i<text.length;i++){
            indx.push(code0.indexOf(text.charAt(i)));
        }
        return indx;
    }
    else if(kay === "code2"){
        for(let i=0;i<text.length;i++){
            indx.push(code2.indexOf(text.charAt(i)));
        }
        return indx;
    }
    else if(kay === "code3"){
        for(let i=0;i<text.length;i++){
            indx.push(code3.indexOf(text.charAt(i)));
        }
        return indx;
    }
    else if(kay === "acode1"){
        for(let i=0;i<text.length;i++){
            indx.push(acode1.indexOf(text.charAt(i)));
        }
        return indx;
    }
    else{
    ...
    if(indx){
        if(kay === "acode1"){
            for (let i = 0; i < indx.length; i++) {
                cod.push(abjed[indx[i]]);
            }
            return cod.join("");
        }
        else{
            for (let i = 0; i < indx.length; i++) {
                cod.push(alpha[indx[i]]);
            }
            return cod.join("");
        }  
    }
